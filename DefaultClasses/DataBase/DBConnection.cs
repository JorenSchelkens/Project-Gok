    ...
    public class DBConnection
    {
            ...
            int beloning)
        {
            try
            {
                ...
                {
                    connection.Open();
                    string sqlCode = "INSERT INTO Achievements(AchievementOmschrijving, Spelernummer, AantalGewonnenGames,Beloning) VALUES('" + omschrijving+ "', " + spelerNummer + ", " + aantalGewonnenGames + ", " + beloning +");";
