...
namespace Gok.Client
{
    public class ApiAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public override async Task<Microsoft.AspNetCore.Components.Authorization.AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            return new Microsoft.AspNetCore.Components.Authorization.AuthenticationState(new ClaimsPrincipal(new ClaimsIdentity(ParseClaimsFromJwt(savedToken), "jwt")));
        }
        ...
        public void MarkUserAsLoggedOut()
        {
            ...
            var authState = Task.FromResult(new Microsoft.AspNetCore.Components.Authorization.AuthenticationState(anonymousUser));
            NotifyAuthenticationStateChanged(authState);
        }
